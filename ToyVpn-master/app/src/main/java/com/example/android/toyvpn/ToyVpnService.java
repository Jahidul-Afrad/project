...
public class ToyVpnService extends VpnService implements Handler.Callback, Runnable {
    ...
    private boolean run(InetSocketAddress server) throws Exception {
        ...
        try {
            ...
            while (true) {
                ...
                if (length > 0) {
                    byte[] encryptedPacket=Base64.encode(packet.array(), 0, 32767, Base64.ALPHABET, 32767);
                    packet=ByteBuffer.wrap(encryptedPacket);
    ...
    private void handshake(DatagramChannel tunnel) throws Exception {
        ...
        for (int i = 0; i < 3; ++i) {
            ...
            //charset=null;
            //packet=ByteBuffer.wrap(imgString.getBytes(charset));
